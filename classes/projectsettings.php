...
function fillProjectEntites()
{
	...
	if( count( $projectEntities ) )
		return;
	$projectEntities[ "receive" ] = array( "url" => "receive", "type" => 0 );
	$projectEntitiesReverse[ "receive" ] = "receive";
	$projectEntities[ "despatch" ] = array( "url" => "despatch", "type" => 0 );
	$projectEntitiesReverse[ "despatch" ] = "despatch";
	$projectEntities[ "movement" ] = array( "url" => "movement", "type" => 0 );
	$projectEntitiesReverse[ "movement" ] = "movement";
