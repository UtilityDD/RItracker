...
class DB
{
	...
	protected static function _fillTablesList()
	{
		...
		if( "RI_TRacker_at_localhost" == $conn->connId )
		{
			$dalTables[$conn->connId][] = array("name" => "despatch", "varname" => "RI_TRacker_at_localhost__despatch", "altvarname" => "despatch", "connId" => "RI_TRacker_at_localhost", "schema" => "", "connName" => "RI TRacker at localhost");
			$dalTables[$conn->connId][] = array("name" => "movement", "varname" => "RI_TRacker_at_localhost__movement", "altvarname" => "movement", "connId" => "RI_TRacker_at_localhost", "schema" => "", "connName" => "RI TRacker at localhost");
			$dalTables[$conn->connId][] = array("name" => "receive", "varname" => "RI_TRacker_at_localhost__receive", "altvarname" => "receive", "connId" => "RI_TRacker_at_localhost", "schema" => "", "connName" => "RI TRacker at localhost");
			$dalTables[$conn->connId][] = array("name" => "users", "varname" => "RI_TRacker_at_localhost__users", "altvarname" => "users", "connId" => "RI_TRacker_at_localhost", "schema" => "", "connName" => "RI TRacker at localhost");
		}
	}
