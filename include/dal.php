...
class tDAL
{
	var $tblRI_TRacker_at_localhost__despatch;
	var $tblRI_TRacker_at_localhost__movement;
	var $tblRI_TRacker_at_localhost__receive;
	var $tblRI_TRacker_at_localhost__users;
	var $lstTables;
	var $Table = array();
	...
	function FillTablesList()
	{
		if($this->lstTables)
			return;
		$this->lstTables[] = array("name" => "despatch", "varname" => "RI_TRacker_at_localhost__despatch", "altvarname" => "despatch", "connId" => "RI_TRacker_at_localhost", "schema" => "", "connName" => "RI TRacker at localhost");
		$this->lstTables[] = array("name" => "movement", "varname" => "RI_TRacker_at_localhost__movement", "altvarname" => "movement", "connId" => "RI_TRacker_at_localhost", "schema" => "", "connName" => "RI TRacker at localhost");
		$this->lstTables[] = array("name" => "receive", "varname" => "RI_TRacker_at_localhost__receive", "altvarname" => "receive", "connId" => "RI_TRacker_at_localhost", "schema" => "", "connName" => "RI TRacker at localhost");
		$this->lstTables[] = array("name" => "users", "varname" => "RI_TRacker_at_localhost__users", "altvarname" => "users", "connId" => "RI_TRacker_at_localhost", "schema" => "", "connName" => "RI TRacker at localhost");
	}
