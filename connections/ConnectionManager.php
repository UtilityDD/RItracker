...
class ConnectionManager
{
	...
	{
		return $this->byId( "RI_TRacker_at_localhost" );
	}
	...
	protected function _setConnectionsData()
	{
		...
		$data = array();
		$data["dbType"] = 0;
		$data["connId"] = "RI_TRacker_at_localhost";
		$data["connName"] = "RI TRacker at localhost";
		$data["connStringType"] = "mysql";
		$data["connectionString"] = "mysql;localhost;root;;;RI TRacker;;1"; //currently unused

		$this->_connectionsIdByName["RI TRacker at localhost"] = "RI_TRacker_at_localhost";
		...
		$data["connInfo"][2] = "";
		$data["connInfo"][3] = "";
		$data["connInfo"][4] = "RI TRacker";
		$data["connInfo"][5] = ""; //currently unused
		$data["connInfo"][6] = "1"; //currently unused
		$data["ODBCString"] = "DRIVER={MySQL ODBC 3.51 Driver};Server=localhost;Uid=root;Pwd=;Database=RI TRacker;OPTION=3";
		// encription set
		...
		$connectionsData["RI_TRacker_at_localhost"] = $data;
	...
	{
		$connectionsIds = array();
		$connectionsIds["receive"] = "RI_TRacker_at_localhost";
		$connectionsIds["despatch"] = "RI_TRacker_at_localhost";
		$connectionsIds["movement"] = "RI_TRacker_at_localhost";
		$connectionsIds["users"] = "RI_TRacker_at_localhost";
